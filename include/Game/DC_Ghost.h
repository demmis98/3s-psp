...
void njDrawTexture(TextureVertex* v, s32 /* unused */, s32 tex, s32 /* unused */);
void njDrawSprite(TextureVertex* v, s32 /* unused */, s32 tex, s32 /* unused */);
void njdp2d_init();
void njdp2d_draw();
void njdp2d_sort(f32* pos, f32 pri, uintptr_t col, s32 flag);
void njDrawPolygon2D(Vertex* v, s32 /* unused */, f32 pri, u32 attr);
